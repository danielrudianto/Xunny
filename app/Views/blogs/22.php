...
<?= $this->section('content') ?>
    ...
    <ol>
        <li>
            <h2 class='h5 mt-5'>Menghemat Biaya untuk Promosi</h2>
            <p>Memang tidak dapat dimungkiri bahwa proses promosi bisnis yang dilakukan secara offline memang membutuhkan biaya yang termasuk kategori yang murah. Bahkan pada awalnya, ketika bisnis baru saja dibuka, bisa diperlukan biaya sampai jutaan rupiah hanya untuk melakukan promosi secara offline. Sementara pemasaran secara digital dapat menghemat pengeluaran khusus promosi bisnis.</p>
        </li>
        <li>
        ...
        <li>
            <h2 class='h5 mt-5'>Memudahkan Komunikasi Konsumen</h2>
            <p>Tidak kalah dari beberapa manfaat yang menguntungkan sebelumnya, ada pula manfaat digital marketing yang dapat dijadikan sebagai bahan pertimbangan terbaik. Apalagi jika memutuskan untuk memanfaatkan jenis metode pemasaran secara digital, maka komunikasi dengan pelanggan dapat dilakukan dengan lebih mudah. Selain itu, setiap pelanggan juga dapat menyampaikan penilaian produk dengan cepat.</p>
        </li>
        <li>
        ...
        <li>
            <h2 class='h5 mt-5'>Meningkatkan Tingkat Penjualan</h2>
            <p>Pada masa Covid-19 yang sedang melanda saat ini, pemasaran bisnis baik barang ataupun jasa secara digital memang semakin marak dilakukan. Apalagi metode ini termasuk ke dalam kategori metode pemasaran yang paling peka terhadap situasi sehingga tidak heran jika penjualan meningkat. Jika penjualan dapat meningkat, maka bisnis dapat bertahan lebih lama.</p>
        </li>
        <li>
        ...
        <li>
            <h2 class='h5 mt-5'>Menambah Jumlah Pendapatan</h2>
            <p>Berkaitan dengan meningkatnya jumlah penjualan yang bisa dinikmati melalui bantuan dari digital marketing, ada juga keuntungan lainnya yang termasuk menarik. Secara sederhana dapat dikatakan bahwa jenis pemasaran ini dapat meningkatkan pula jumlah pendapatan yang dimiliki oleh setiap pebisnis termasuk pemula. Manfaat ini tentu saja tidak akan dilewatkan pebisnis begitu saja.</p>
        </li>
        <li>
        ...
        <li>
            ...
            <p>Berbeda dengan jenis pemasaran secara offline yang bisa berkesan berlebihan dan membuang tenaga serta waktu, pemasaran digital justru bersifat sebaliknya. Apalagi ternyata jenis pemasaran dengan metode yang semakin populer ini ternyata menawarkan stabilitas dengan tingkatan yang jauh lebih tinggi. Selain itu, keuntungan tersebut secara otomatis mudah untuk disesuaikan dengan tren.</p>
        </li>
        <li>
        ...
        <li>
            ...
            <p>Manfaat yang terakhir ini memiliki keterkaitan erat dengan persoalan analisis tren penjualan produk baik barang ataupun jasa di pasar Indonesia. Melalui data dan riwayat yang sudah disediakan dan dipelihara dengan baik melalui sebuah situs, proses evaluasi pun lebih mudah dilakukan. Selain itu, evaluasi perlu dilakukan dengan rutin sesuai rencana masing-masing.</p>
            <p>Uraian mengenai beberapa manfaat digital marketing secara detail di atas bisa dimasukkan ke dalam bahan pertimbangan sebelum langsung mencoba nantinya. Apalagi tidak dapat dielakkan bahwa pada masa sekarang memang semakin banyak orang yang lebih memilih untuk menikmati produk secara online. Situasi seperti itu tentu saja dapat dimanfaatkan perusahaan dengan sebaik-baiknya.</p>
        </li>
    </ol>
    <p>Berdasarkan uraian di atas, manfaat yang ditawarkan oleh pemasaran secara digital memang bervariasi mulai dari persoalan promosi sampai pada keuntungan. Selain itu, keberadaan metode pemasaran secara digital tersebut dapat membantu setiap perusahaan terutama pemula untuk melakukan analisis bisnis secara rutin. Ditambah lagi, ada pula manfaat yang berkaitan dengan proses evaluasi. Cek portfolio kami <a href='<?= base_url() ?>/#Portfolio'>disini</a> untuk aplikasi yang kami buat sebelumnya.</p>
<?= $this->endSection() ?>