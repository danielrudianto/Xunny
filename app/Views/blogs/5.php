...
<?= $this->section('content') ?>
	...
	<p>Sebelum membuat desain website, kita tentu harus paham terlebih dahulu dalam membuat desain untuk mencapai tujuan lain, yaitu mudah untuk digunakan.</p> 
	...
	<p>Setelah anda mengetahui bagaimana dasar cara pembuatan website, maka anda akan lebih mudah dalam membuat desain <i>website</i>yang mudah digunakan. Saat ini, banyak orang yang tidak tertarik dengan suatu <i>website</i>karena tampilan <i>website</i>tersebut kurang menarik atau sulit untuk digunakan. Sebenarnya yang menentukan <i>user friendly</i>  dari suatu <i>website</i>adalah bagaimana pengemasan desain UI dan UX <i>website</i>tersebut. </p>

	<p>User interface dalam <i>website</i>adalah proses yang digunakan untuk membuat tampilan <i>website</i>yang berfokus pada tampilan atau gaya agar membuat interaksi pengguna sesederhana dan seefisien mungkin, dalam hal mencapai tujuan pengguna. User experience dalam <i>website</i>adalah proses pengalaman pengguna terhadap website, yang digunakan untuk meningkatkan kegunaan, kemudahan penggunaan, dan kesenangan yang diberikan oleh <i>website</i>pada pengguna.</p>

	<p class='mt-5'><strong>Lalu, bagaimana membuat desain <i>website</i>yang mudah untuk digunakan?</strong></p>
	<ol>
		<li>
	...
	Selain itu, anda juga perlu berkomunikasi dengan pengguna anda dalam menggunakan elemen visual. Anda bisa menambahkan beberapa fitur menarik pada <i>website</i>anda, seperti geser ke kiri untuk mencari kecocokan pada tinder atau tambahkan teman pada facebook. Hal yang perlu diperhatikan, gunakanlah fitur yang jelas dan ringkas. Usahakan anda bisa menjelaskan sesuatu dalam kalimat yang sedikit saja. Fitur yang anda gunakan juga harus familiar dan responsif. Interface <i>website</i>yang kamu gunakan harus bekerja dengan cepat.
	</p>
<?= $this->endSection() ?>