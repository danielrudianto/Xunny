...
<?= $this->section('content') ?>
    ...
    <p>Informasi dan teknologi yang kian berkembang membuat sejumlah pelaku usaha mencoba menerapkannya pada sistem perusahaan. Membuatnya aplikasi tersebut menjadi penunjang yang harus ada dalam sebuah perusahaan. Alasan pentingnya aplikasi tersebut adalah:</p>
    <ol>
        <li>
            <h3 class='h5 mt-5'>Pendataan Barang yang Lebih Mudah</h3>
            <p>Sekarang setiap detail barang masuk dan keluar sudah dalam terekam dan tercatat dalam sebuah aplikasi yang diperuntukkan untuk mendata barang. Hal tersebut memungkinkan pelaku usaha tidak perlu mencatatnya secara manual pada pembukuan. Selain itu pendataan yang dibuat manual tersebut beresiko terjadi kesalahan.</p>
            <p>Berbeda ketika pengguna menggunakan aplikasi penjualan dan stok barang, apa pun jenis transaksinya akan terdata secara otomatis. Pengguna hanya perlu untuk memasukkan detail dari data yang diperlukan ke dalamnya. Tingkat resiko kesalahan input pun sangat jarang terjadi, sehingga minim resiko.</p>
        </li>
        <li>
        ...
        <li>
            <h3 class='h5 mt-5'>Memperlihatkan Kondisi Persediaan Secara Akurat</h3>
            <p>Dalam bisnis atau usaha yang menghasilkan produk tertentu perlu untuk mengetahui jumlah persediaan barang yang dimiliki. Hal tersebut dilakukan untuk memudahkan pekerjaan dalam pre order dan mencocokan nilai transaksi. Jadi, hasil penjualan dengan stok yang ada menjadi balance atau seimbang.</p>
            <p>Penggunaan aplikasi penjualan dan stok barang terbukti lebih akurat dibandingkan cara manual yang dilakukan. Kesalahan yang terjadi dalam sebuah program sangat jarang terjadi, dikarenakan sistem yang sudah terkomputerisasi. Hadirnya sistem pengendalian internal, memungkinkan ketersediaan barang setiap bulannya sesuai dengan laporan keuangan.</p>
        </li>
        <li>
